...
// 	return 0;
// }
// Greedy Approach but fail for the cases like n = 3 k = 1 [5,5,10] Ans = 10 but above solution give 15

// This is the correct ans pass all the major test cases and corner cases.
#include<bits/stdc++.h>
using namespace std;
